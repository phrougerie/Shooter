 ...
 *
 */
public class Ennemy4 extends Ennemy {    Image img = new Image(Main.class.getResource("image")+"/Ennemys/e05.png");
    ...
    public Ennemy4(double xmax,double ymax ) {
        this.xmax = xmax;
        this.ymax = ymax;
    ...
    private void SetterPath(Path p, Group root){
        ...
        if(cursor.getHitbox().getLayoutX()>=xmax/2) { p.getElements().add(new LineTo(-40+xmax-cursor.getHitbox().getLayoutX(),ymax-400));
            p.getElements().add(new LineTo(-(-40+xmax-cursor.getHitbox().getLayoutX()),ymax+60));
        }
        else{p.getElements().add(new LineTo(-cursor.getHitbox().getLayoutX()+20,ymax-400));
            p.getElements().add(new LineTo(-40+xmax-cursor.getHitbox().getLayoutX(),ymax+60));
        }
    ...
    public void setPathTransition() {
        ...
        pathTransition.setDuration(Duration.seconds(4.8));
    ...
    public void setPathTransitionS() {
        ...
        pathTransitionS.setDuration(Duration.seconds(4.8));
